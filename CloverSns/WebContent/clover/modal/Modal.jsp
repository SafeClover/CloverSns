...
<script>
    ...
    function UpLoad(){
        ...
        if(document.uploadModal.upFile.value == "" ){
           alert("업로드할 사진을 선택하세요!");
           return;
        }
        if(document.uploadModal.title.value == ""){
           alert("제목을 입력해주세요~");
           document.uploadModal.title.focus();
           return;
        }
        
        theForm.action = "/CloverSns/uploadmodal.uploadmodal_proc?link=" + link ;
        theForm.submit();
     }
      ...
      <div class="row">
         <div class="modal fade uploadModal" id="uploadModal">
            <div class="modal-dialog">
               <div class="modal-content" style="background-image: url('/CloverSns/style/img/UpModal.jpg');">
                 	 ...
                 	 <div>
                  		<div class="modal-body" style="float:left; width:50%; height:330px;">            
                     		<div class="modal-body" style="width:100%; height:105%; background-color:white;">
                    	 		<img style="width:100%; height:105%;" class="img-responsive center-block" id="blah" alt="업로드할 사진을 선택해주세요" name="image"/>
                     		</div>
                   		</div>
                  		...
                  		<div class="modal-body">
                  			<div class="modal-body" align="center">
                  				...
                  				<input type="radio" name="btn" value="privacy" checked="checked" />비공개&nbsp;
