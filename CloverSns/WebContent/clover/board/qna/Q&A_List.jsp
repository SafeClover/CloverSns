				...
				<td colspan="4" valign="top">
							...
							<div class="span10">
								...
								<!-- 계정 만들기 -->
									<div class="accordion-group">
										...
										<div id="account_add" class="accordion-body collapse">
									...
									<div class="accordion-group">
										...
										<div id="how_login" class="accordion-body collapse out">
											<div class="accordion-inner">
									...
									<div class="accordion-group">
										...
										<div id="no_login" class="accordion-body collapse out">
											<div class="accordion-inner">
					<pre>
					...
					- 비밀번호를 재설정하세요.
									...
									<div class="accordion-group">
										...
										<div id="how_logout" class="accordion-body collapse out">
											<div class="accordion-inner">
									...
									<div class="accordion-group">
										...
										<div id="edit_info" class="accordion-body collapse out">
											<div class="accordion-inner">
								...
								<!-- 비밀번호 분실 -->
									<div class="accordion-group">
										...
										<div id="pass_lose" class="accordion-body collapse out">
											<div class="accordion-inner">
									...
									<div class="accordion-group">
										...
										<div id="re_pass" class="accordion-body collapse out">
											<div class="accordion-inner">
												우측 상단의 아이디 클릭 -> 회원정보 수정 클릭 -> 정보 입력 후 정보변경 클릭
											</div>
										</div>
								...
								<!-- 친구 찾기 -->
									<div class="accordion-group">
										...
										<div id="search_friends" class="accordion-body collapse out">
											<div class="accordion-inner">
									...
									<div class="accordion-group">
										...
										<div id="how_up" class="accordion-body collapse out">
											<div class="accordion-inner">
									...
									<div class="accordion-group">
										<div class="accordion-heading">
											...
											data-parent="#theAccordion">게시글 공개설정</a>
										</div>
										<div id="privacy" class="accordion-body collapse out">
											<div class="accordion-inner">
									...
									<div class="accordion-group">
										...
										<div id="news" class="accordion-body collapse out">
											<div class="accordion-inner">
					<pre>
					...
					- 이미지를 볼 수 있는 시간이 지나고 나면 감상평을 작성할 수 있습니다.
									...
									<div class="accordion-group">
										...
										<div id="contest" class="accordion-body collapse out">
											<div class="accordion-inner">
					<pre>
