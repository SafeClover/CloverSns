...
<script type="text/javascript">
	...
	function open_id(){
		window.open("/CloverSns/clover/find/Find_id.jsp", "아이디 찾기", "width=400, height=250, scrollbars=no, left=150, top=150");
	}
	
	function open_pw(){
		window.open("/CloverSns/clover/find/Find_pw.jsp", "비밀번호 찾기", "width=400, height=250, scrollbars=no, resizeable=no, left=150, top=150");
	}
</script>
<style>
	body{
...
<!-- 페이지의 아이디 비밀번호 로그인 회원가입 버튼 영역 -->
	...
	<div class="container" style="vertical-align: middle; margin-bottom: 0px; margin-top: 27%; margin-left: 60%">
		...
		<div class="row">
			<a href="javascript:open_id()" style="position: absolute; top: 630px; left: 1100px; text-decoration: none;" ><small style="font-size: 18px; font-weight: bold;">아이디 찾기</small></a><br/>
			<a href="javascript:open_pw()" style="position: absolute; top: 655px; left: 1100px; text-decoration: none;" ><small style="font-size: 18px; font-weight: bold;">비밀번호 찾기</small></a>
		</div>
		<!-- 버튼 폼 끝 -->
	</div>
<!-- container 끝 -->
